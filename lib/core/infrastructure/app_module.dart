...
final appModule = Module()
  ...
  ..factory((scope) =>
      LoginScreenCubit(scope.get<SpotifyRepository>(), scope.get<GlobalUiCubit>(), scope.get<TokenRepository>()))
  ..factory((scope) => HomeBloc(scope.get<TokenRepository>()))
  ..factory((scope) => ArtistsCubit(scope.get<SpotifyRepository>(), scope.get<GlobalUiCubit>()))
  ..factory((scope) => TracksCubit(scope.get<SpotifyRepository>(), scope.get<GlobalUiCubit>()))
  ..factory((scope) =>
      ProfileCubit(scope.get<SpotifyRepository>(), scope.get<GlobalUiCubit>(), scope.get<TokenRepository>()));
